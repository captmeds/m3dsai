          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {processSteps.map((step, index) => (
              <motion.div
                ...
                className="relative"
              >
                <div className="glass rounded-2xl p-8 h-full relative z-10 hover:border-accent-primary/50 transition-colors duration-300">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-accent-primary to-accent-secondary flex items-center justify-center mb-6">
